        ...
        <div>
            <div className = "w-full flex justify-center border-b bg-neutral-50 border-gray-200 relative z-50">
                <div className = "container flex justify-between items-center h-24 relative z-50 px-4">
                    <p className = "text-3xl max-md:text-2xl font-bold">
                        ...
                        <span className = "text-[#006664]">Moss</span>
                    </p>
                    ...
                    <div className = "flex justify-center items-center px-6 h-10 gap-2 bg-[#006664] text-base text-neutral-50 font-semibold rounded-xl shadow-md border-2 border-[#006664] hover:bg-neutral-50 hover:text-[#006664] duration-200 max-md:hidden">
                        <i className = "fa-regular fa-map"></i>
                        <p>Map</p>
                    </div>
                    <div onClick = {toggleMenu} className = {`flex justify-center items-center w-10 h-10 text-base font-semibold rounded-xl shadow-md border-2 border-[#006664] hover:bg-neutral-50 hover:text-[#006664] duration-200 md:hidden ${menu ? "bg-neutral-50 text-[#006664]" : "bg-[#006664] text-neutral-50"}`}>
            ...
            <div className = {`absolute ${menu ? "translate-y-24" : "-translate-y-full"} left-0 top-0 bg-neutral-50 w-screen h-[calc(100% - 6rem)] border-t border-gray-200 flex justify-center transition-transform duration-500 ease-in-out z-40 md:hidden`}>
                <div className = "container bg-neutral-50 px-4 py-4 flex flex-col gap-4">
                    ...
                    <div className = "flex justify-center items-center px-6 h-10 gap-2 bg-[#006664] text-sm text-neutral-50 font-semibold rounded-xl shadow-md border-2 border-[#006664] hover:bg-neutral-50 hover:text-[#006664] duration-200">
                        <i className = "fa-regular fa-map"></i>
                        <p>Map</p>
                    </div>
                </div>
